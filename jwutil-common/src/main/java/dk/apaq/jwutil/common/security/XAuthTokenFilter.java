...
public class XAuthTokenFilter extends GenericFilterBean {
    ...
    public XAuthTokenFilter(UserDetailsService detailsService, TokenProvider tokenProvider, AuthenticationEntryPoint authenticationEntryPoint) {
        ...
        try {
            ...
            if (StringUtils.hasText(authToken)) {
                if (this.tokenProvider.validateToken(authToken)) {
                    UserDetails details = this.tokenProvider.getUserDetailsFromToken(authToken);
