...
import dk.apaq.jwutil.common.security.RestAuthenticationEntryPoint;
import dk.apaq.jwutil.common.security.TokenProvider;
import dk.apaq.jwutil.common.security.XAuthTokenConfigurer;
...
public class AppConfig extends WebSecurityConfigurerAdapter {
    ...
    private XAuthTokenConfigurer securityConfigurerAdapter() {
      return new XAuthTokenConfigurer(userDetailsService, tokenProvider, authenticationEntryPoint);
    }
