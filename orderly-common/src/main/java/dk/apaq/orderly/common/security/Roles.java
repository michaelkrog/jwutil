...
public class Roles {
    ...
    public static final String UNITROLE_ADMIN = "ADMIN";
    public static final String UNITROLE_USER = "USER";
    public static final String UNITROLE_PUBLIC = "PUBLIC";
    public static final String UNITROLE_SECRET = "SECRET";
    ...
    public static boolean isAdminRole(String role) {
        return role.endsWith(SEPARATOR + UNITROLE_ADMIN);
    }
