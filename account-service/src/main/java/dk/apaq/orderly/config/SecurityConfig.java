...
import dk.apaq.orderly.security.AccountUserDetailsService;
import dk.apaq.orderly.security.SpringSecurityAuditorAware;
import dk.apaq.orderly.security.StandardSecurityModel;
...
public class SecurityConfig extends GlobalMethodSecurityConfiguration {
    ...
    protected MethodSecurityExpressionHandler createExpressionHandler() {
        ...
        expressionHandler.setPermissionEvaluator(new StandardSecurityModel());
